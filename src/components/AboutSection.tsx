...
<div className="mt-6 bg-black flex flex-col md:flex-row relative">
  ...
  <div className="flex-1 flex flex-col justify-center gap-4 px-5 py-6 md:px-10 md:py-10">
    <p className="text-sm sm:text-base md:text-lg leading-relaxed text-neutral-300 max-w-xl">
      ...
      specializes in building modern web applications and digital experiences
      using technologies like Spring Boot, React, Vue.js, and Tailwind CSS.
    </p>

    <p className="text-sm sm:text-base md:text-lg leading-relaxed text-neutral-300 max-w-xl">
      Beyond coding, he is dedicated to sharing knowledge through workshops,
      tutorials, and technical content across platforms like YouTube, Instagram,
      and Medium.
    </p>

    <p className="text-sm sm:text-base md:text-lg leading-relaxed text-neutral-300 max-w-xl">
      Abdelghani also co-organized hackathons such as Gemini Hack Night, where
      he supported participants in building AI-powered projects and
